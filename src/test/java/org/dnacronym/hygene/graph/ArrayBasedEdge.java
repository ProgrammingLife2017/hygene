...
/**
 * ArrayBasedEdge class used with the internal data structure.
 */
public final class ArrayBasedEdge implements Comparable<ArrayBasedEdge> {
    ...
    /**
     * Constructs and initializes a new {@link ArrayBasedEdge}.
     *
     ...
     */
    public ArrayBasedEdge(final int from, final int to, final int byteOffset, final @Nullable Graph graph) {
        this.from = from;
        this.to = to;
    ...
    /**
     * Getter for the {@link ArrayBasedEdge}'s source node.
     *
    ...
    /**
     * Getter for the {@link ArrayBasedEdge}'s destination.
     *
    ...
    /**
     * Getter for the {@link ArrayBasedEdge}'s byte offset.
     *
    ...
    /**
     * Compares this edge to another {@link ArrayBasedEdge}.
     * <p>
     * First the destination 'to' is compared. If {@code to == other.to}, the source 'from' will be used for comparison.
     *
     * @param other {@link ArrayBasedEdge} to compare this edge with
     ...
     */
    @Override
    public int compareTo(final ArrayBasedEdge other) {
    ...
    public boolean equals(final @Nullable Object other) {
        ...
        final ArrayBasedEdge edge = (ArrayBasedEdge) other;
