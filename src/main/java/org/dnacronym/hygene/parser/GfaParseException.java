...
/**
 * Indicates that an error has occurred during the parsing of a {@link GfaFile}.
 */
public final class GfaParseException extends Exception {
    /**
     ...
     */
    public GfaParseException(final String message) {
        super(message);
    }
     ...
     */
    public GfaParseException(final String message, final Throwable cause) {
        super(message, cause);
    }
}
