...
/**
 * Indicates that an error has occurred during the parsing of a {@link GffFile}.
 */
public final class GffParseException extends Exception {
    /**
     ...
     */
    public GffParseException(final String message) {
        super(message);
    }
     ...
     */
    public GffParseException(final String message, final Throwable cause) {
        super(message, cause);
    }
}
