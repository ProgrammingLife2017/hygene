...
public class UIInitialisationException extends Exception {
     ...
     *
     * @param message the detail message. The detail message is saved for later retrieval by the {@code
     ...
     * message.
     *
     * @param cause   the detail message (which is saved for later retrieval by the {@code Throwable.getMessage()}
     *                method).
     * @param message the cause (which is saved for later retrieval by the {@code Throwable.getCause()} method). (A
